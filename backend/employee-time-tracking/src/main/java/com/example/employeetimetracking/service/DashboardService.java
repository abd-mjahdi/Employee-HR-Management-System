...
public class DashboardService {
    ...
    @Autowired
    public DashboardService(CompanyMembershipRepository companyMembershipRepository,
    ...
    public UserDashboardDto getDashboardData(CustomUserDetails authenticatedUser){
        ...
        UserResponseDto userResponseDto = userMapper.toDto(user, membership);
    ...
    public DashboardStatsDto getDashboardStats(User user, UserRole role) {
        ...
        if (role == UserRole.HR_ADMIN) {
            activeUsers = Math.toIntExact(companyMembershipRepository.countByCompanyIdAndStatus(
                    TenantContext.require().companyId(), MembershipStatus.ACTIVE));
        }
